...
const ContuctForm = () => {
  ...
  return (
    <div data-aos="fade-up" id="contact" className="">
      <h1 className="text-4xl text-primary my-20 font-bold text-center uppercase ">
        Contact
      </h1>
      <div className="lg:grid grid-cols-2 gap-5 w-[80%] mx-auto ">
        <div data-aos="fade-up" className="bg-gradient-to-r from-primary to-[#852f17] lg:px-10 py-16 ">
          ...
          >
            ...
            <input
              ...
              name="from_name"
              placeholder="Name"
              className="input outline-none  mb-4  w-full "
            />
            <input
              style={{
                background: "none",
            ...
            <button
              type="submit"
              className="btn bg-white border-none text-primary font-bold hover:text-white hover:bg-[#082044] btn-sm"
            >
              Send
            </button>
          </form>
        ...
        <div data-aos="fade-up" className="text-white flex flex-col justify-center px-5 mt-10 lg:mt-0">
          ...
          <p className="text-slate-600 mb-9 font-semibold ">
          ...
          <div className="text-slate-500">
            <div className="flex items-center mb-12">
              ...
              <p className="text-sm">
                <span className="font-bold">Address:</span>Muktagacha Mymensing
                Road,Jamalpur 2000
              </p>
            </div>
            <div className="flex items-center mb-12">
              ...
              <p className="text-sm">
                <span className="font-bold">Phone:</span>+8801306910346
              </p>
            </div>
            <div className="flex items-center mb-12">
